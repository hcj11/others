...
@Getter
@Setter
public class WordsFinderWithSynchronize {
 ...
 static {
  ...
  public static void main(String[] args) {
    WordsFinderWithSynchronize wordsFinder = new WordsFinderWithSynchronize();
    WordsFinderWithNoSyncMain(wordsFinder);
  }

  public static void WordsFinderWithNoSyncMain(WordsFinderWithSynchronize wordsFinder) {
...
//    }
  ...
  public synchronized  void dataAppend() {
    // 随机获取 [0,1) -> [0,30)
