...
@Getter
@Setter
public class WordsFinderWithCas {

//  private static ConcurrentLinkedQueue<StringBuilder> queue = new ConcurrentLinkedQueue<>();

  private static AtomicReference<StringBuilder> atomicReference =new AtomicReference<StringBuilder>();
 ...
 static {
   ...
   String ss = "For too long a small group in our nation's capital has reaped "
        + "the rewards of government while the people have borne the ping wcost "
  ...
  public static void main(String[] args) {
    WordsFinderWithCas wordsFinder = new WordsFinderWithCas();
    WordsFinderWithNoSyncMain(wordsFinder);
  }

  public static void WordsFinderWithNoSyncMain(WordsFinderWithCas wordsFinder) {
