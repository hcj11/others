...
public class PhaserTest4 {
    ...
    public static void main(String args[]) throws Exception {  
        ...
        final Phaser phaser = new Phaser(count) { //0-5=6  // 5 , 0,1,2,3,4
            @Override  
            protected boolean onAdvance(int phase, int registeredParties) {  
                System.out.println("====== " + phase + " ======"+"registeredParties===="+registeredParties);
        ...
        // 需比对是否相等 ，  phasers[相位器分父和子相位] parties[固定]  <-> arrivaled[动态变化]
